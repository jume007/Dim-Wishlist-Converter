...
data_dir = os.path.join(script_dir, '..', 'Ageis_Data')
excel_file = os.path.join(data_dir, 'Destiny 2_ Endgame Analysis.xlsx')
output_file = os.path.join(data_dir, 'Destiny 2_Endgame Analysis.json')
...
if os.path.exists(excel_file):
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        json.dump(column_b_names, f, indent=4)
else:
    raise FileNotFoundError(f"Excel file not found at {excel_file}. Please place it in the Ageis_Data directory relative to the script.")
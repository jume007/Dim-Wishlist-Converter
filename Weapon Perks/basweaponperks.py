...
def extract_base_weapon_perks():
    # Define file paths
    weapon_hash_path = r"E:\Windows\Documents\D2 API\Weapons_Hash\weapon_hashes_final.json"
    collectible_data_path = r"E:\Windows\Documents\D2 API\Weapon Perks\DestinyCollectibleDefinition.json"
    ...
    output_path = r"E:\Windows\Documents\D2 API\Weapon Perks\BaseWeaponPerks.json"
    ...
    # Extract weapon names from weapon_hashes_final.json
    weapons = []
